...
import { Auth, UserProfile } from "@/components/features/Auth";
    ...
    <div className="container mx-auto py-10 px-4 max-w-4xl">
      ...
      <Alert className="mb-6">
        ...
        <AlertDescription>
          ...
          <strong className="block mt-2">You need to be signed in to upload files due to Row Level Security policies.</strong>
        </AlertDescription>
      </Alert>
            ...
            <TabsContent value="about">
              <div className="space-y-4">
                ...
                <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
                  ...
                  <li>Authentication required due to Row Level Security policies</li>
                </ul>
...
<a href="${uploadedFiles[0]?.url || '[file-url]'}" download>Download File</a>`}
        ...
        <div className="mt-6">
          <h2 className="text-xl font-semibold mb-4 text-center">Sign In to Upload Files</h2>
          <p className="text-center text-muted-foreground mb-6">
            Authentication is required to upload files due to Supabase Storage's Row Level Security policies.
          </p>
          <Auth />
        </div>
      )}
